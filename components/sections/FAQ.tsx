...
const faqs = [
  {
    question: "В яких областях України працює евакуатор?",
    answer:
      "Наразі працюємо в таких областях: Львівська, Вінницька, Дніпропетровська, Івано-Франківська, Одеська, Рівненська, Тернопільська, Харківська, Хмельницька, Черкаська, Чернігівська, Чернівецька, Волинська, Житомирська, Кіровоградська. Київ та Київська область — окремий напрямок з власними тарифами.",
  },
  {
    question: "Скільки коштує евакуатор по Києву?",
    answer:
      "Вартість складається з подачі евакуатора від 1500 до 2500 грн та оплати за кілометраж — 50 грн/км. Для перевезень понад 500 км ціна від 20 грн/км без фіксованої подачі. Фінальна вартість залежить від габаритів авто та складності ситуації.",
  },
  {
    question: "Скільки коштує евакуатор по Україні?",
    answer:
      "По областях України вартість складається з подачі евакуатора від 1000 грн та та оплати за кілометраж — 50 грн/км.",
  },
  {
